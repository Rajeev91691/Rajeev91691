...
# ===========================================================================
HOST = "Rajeev91691"   # shown as  Rajeev91691@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "B.Tech CSE Candidate @ GITAM University"),
    ("kv", "Focus", "Generative AI & Full-Stack Engineering"),
    ("kv", "Edu", "Visakhapatnam, India (GPA: 9.27/10)"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, C/C++, Java, JavaScript, TypeScript"),
    ("kv", "AI / ML", "PyTorch, Stable Diffusion, HuggingFace, FastAPI"),
    ("kv", "Frontend", "React, Next.js, Tailwind, Framer Motion, Three.js"),
    ("kv", "Web3D", "GSAP, WebGL, React Three Fiber"),
    ("kv", "Databases", "MySQL, SQLite, MongoDB"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "IIT Kanpur Research — Stable Diffusion (-15% FID, -22% latency)"),
    ("bul", "Portfolio — Scroll-scrubbed 1080p Next.js editorial website"),
    ("bul", "Bondapalli — WebGL spatial road levels dashboard & DXF parser"),
]
